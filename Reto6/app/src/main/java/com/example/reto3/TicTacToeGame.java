...
public class TicTacToeGame {
    ...
    public boolean setMove(char player, int location) {
        ...
        if (player == COMPUTER_PLAYER && mBoard[location] == COMPUTER_PLAYER) {
            return true;
        }
        displayBoard();
        return false;
    ...
    private void displayBoard()	{
        Log.i(TAG, "\n");
        Log.i(TAG,mBoard[0] + " | " + mBoard[1] + " | " + mBoard[2]);
        Log.i(TAG,"-----------");
        Log.i(TAG,mBoard[3] + " | " + mBoard[4] + " | " + mBoard[5]);
        Log.i(TAG,"-----------");
        Log.i(TAG,mBoard[6] + " | " + mBoard[7] + " | " + mBoard[8]);
        Log.i(TAG, "\n");
    }
